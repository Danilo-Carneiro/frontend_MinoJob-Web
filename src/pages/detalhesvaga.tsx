                    ...
                    <form className={styles.containerForm} action="Criar Vaga">
                        ...
                        <div className={styles.infosPrincipal}>
                            ...
                            <div className={styles.info}>
                                ...
                                <select className={styles.select} name="Areas" id="">
                            ...
                            <div className={styles.info}>
                                ...
                                <textarea className={styles.input} id={styles.textarea} 
                        ...
                        <fieldset className={styles.fieldset}>
                            <strong className={styles.title}>Local de trabalho</strong>
                        ...
                        <div className={styles.boxBtns}>
                            <button className={styles.btn} id={styles.btnCandidatos}type="button">Ver Candidatos</button>
